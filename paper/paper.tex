...
\begin{enumerate}[leftmargin=2em,label=(\alph*)]
\item The two inputs of the proof are of different status: the bound $e(S)\le s+p+C$ in Regions II and III (\cref{sec:regionII,sec:regionIII}) is part of the formalised \cref{thm:main15}, while \cref{thm:N3} is not formalised.
